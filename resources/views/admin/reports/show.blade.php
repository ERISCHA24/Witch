    ...
    <div style="display:grid;grid-template-columns:1fr 360px;gap:24px;align-items:start;">
        ...
        <div style="display:flex;flex-direction:column;gap:20px;">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div style="font-size:15px;color:var(--text);line-height:1.8;max-height:420px;overflow-y:auto; autoflow-wrap: break-word; word-break: break-word;scrollbar-width:thin;scrollbar-color:#CBD5E1 transparent;">
                        {{ $report->description }}
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div style="display:flex;align-items:center;gap:10px;">
                        <span style="font-size:12px;color:var(--text-light);font-family:'IBM Plex Mono',monospace;">{{ $report->progressUpdates->count() + 1 }} entri</span>
                        @if($report->progressUpdates->count() >= 3)
                        <span style="font-size:11.5px;color:var(--text-light);display:flex;align-items:center;gap:3px;">
                            <svg width="12" height="12" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                            Scrollable
                        </span>
                        @endif
                    </div>
                    ...
                    <div class="timeline" style="position:relative;padding-left:28px;">
                        ...
                        <div style="position:relative;margin-bottom:20px;">
                            ...
                            <div style="background:var(--bg);border:1px solid var(--border);border-radius:8px;padding:12px 14px;">
                                <div style="font-size:13.5px;color:var(--text);line-height:1.6;overflow-wrap:break-word;word-break:break-word;">✍️ Laporan diajukan oleh <strong>{{ $report->user->name ?? 'warga' }}</strong> dan masuk ke antrian verifikasi.</div>
                            </div>
                        </div>
        ...
        <div style="display:flex;flex-direction:column;gap:16px;">
            ...
            <div class="danger-zone" x-data="{ open: false }">
                ...
                <button type="button" @click="open = true" class="btn btn-danger" style="width:100%;justify-content:center;margin-top:12px;">
                🗑️ Hapus Laporan Ini
                </button>
            ...
            <div x-show="open" 
                ...
                <div @click.away="open = false" 
                    ...
                    <div style="display:flex;justify-content:center;gap:10px;">
                        ...
                        <button type="submit" class="btn btn-danger btn-sm" style="background:var(--danger);color:#fff;border-color:var(--danger);">
                            Hapus 
                        </button>
                    </div>
                </div>
