...
<head>
    ...
    <style>
        :root {
            ...
            --text-muted: #45505f; --text-light: #94A3B8;
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body { 
            ...
            background-image: linear-gradient(to right, rgba(22, 45, 110, 0.15) 1px, transparent 1px), linear-gradient(to bottom, rgba(22, 45, 110, 0.15) 1px, transparent 1px); 
        ...
        .hv-title { color: rgba(255,255,255,0.8); font-size: 15px; font-weight: 500; margin-left: 4px; }
        ...
        .hv-report-img { width: 30px; height: 30px; border-radius: 8px; background: #E2E8F0; flex-shrink: 0; display: flex; align-items: center; justify-content: center; font-size: 24px; }
        .hv-report-info { flex: 1; }
        .hv-report-title { font-size: 24px; font-weight: 600; color: var(--text); margin-bottom: 4px; }
...
<body>
            ...
            <div class="nav-actions">
                @auth
                    @if(Auth::user()->role === 'admin')
                        <a href="{{ route('admin.dashboard') }}" class="nav-btn nav-btn-primary">Dashboard</a>
                    @else
                        <a href="{{ route('citizen.dashboard') }}" class="nav-btn nav-btn-primary">Dashboard</a>
                    @endif
                @else
    ...
    <section>
        <div class="hero">
            <div class="hero-content">
                ...
                <p class="hero-desc">CivilWatch memudahkan warga melaporkan kerusakan infrastruktur publik secara transparan dan terukur. Setiap laporan langsung diteruskan kepada instansi berwenang. Gratis tidak dipungut biaya.</p>
            </div>
        <div class="hero-visual">
            <div class="hv-header">
                ...
                <span class="hv-title">Data Real-Time Platform CivilWatch</span>
            </div>
            <div class="hv-body">
                <div class="hv-report">
                    <div class="hv-report-info" style="display:flex;align-items:center;justify-content:center;gap:24px;width:100%">
                        <span class="hv-badge published-badge" style="font-size:30px;font-weight:bold;white-space:nowrap">
                            {{ number_format($totalReports) }}<span></span>
                        </span>
                        <div class="hv-report-title" style="margin:0;margin-right:72px;">Laporan Masuk</div>
                    </div>
                </div>
                <div class="hv-report">
                    <div class="hv-report-info" style="display:flex;align-items:center;justify-content:center;gap:24px;width:100%">
                        <span class="hv-badge in-progress-badge" style="font-size:30px;font-weight:bold;white-space:nowrap">
                            {{ number_format($inProgressReports) }}<span></span>
                        </span>
                        <div class="hv-report-title" style="margin:0;margin-right:42px;">Sedang Ditangani</div>
                    </div>
                </div>
                <div class="hv-report">
                    <div class="hv-report-info" style="display:flex;align-items:center;justify-content:center;gap:24px;width:100%">
                        <span class="hv-badge resolved-badge" style="font-size:30px;font-weight:bold;white-space:nowrap">
                            {{ number_format($resolvedReports) }}<span></span>
                        </span>
                        <div class="hv-report-title" style="margin:0">Berhasil Diselesaikan</div>
                    </div>
                </div>
                <div class="hv-report">
                    <div class="hv-report-info" style="display:flex;align-items:center;justify-content:center;gap:24px;width:100%">
                        <span class="hv-upvote" style="font-size:30px;font-weight:bold;white-space:nowrap">
                            {{ number_format($totalUpvotes) }}<span></span>
                        </span>
                        <div class="hv-report-title" style="margin:0;margin-right:42px;">Dukungan Warga</div>
                    </div>
                </div>
            </div>
    </section>
        ...
        <div class="cta-inner">
            ...
            <div class="cta-btns">
                @auth
                    ...
                    <a href="{{ route('feed') }}" class="cta-btn-outline-white">📋 Laporan Warga</a>
                @else
                    <a href="{{ route('register') }}" class="cta-btn-white">🚀 Daftar Sekarang</a>
                    <a href="{{ route('login') }}" class="cta-btn-outline-white">Masuk Sekarang</a>
                @endauth
            </div>
        </div>
    </div>
    ...
    <footer>
        <div class="footer-inner">
            <div class="footer-brand">CivilWatch</div>
